            ...
            <div className="container">
                <div className="row">
                    ...
                    <div className="col-lg-6 col-md-6 col-sm-12  my-5">
                        <p className='text-light ms-5'>I have recently completed graduation Bachelor of Computer Application from Indus University, My career objective is to secure a challenging and dynamic position in a reputed organization, where I can utilized my skills and knowledge to grow professionally.</p>
                        <ul className="about-info mt-4 px-md=0 px-5 text-light">
                            ...
                            <li className="text-light eduaction mt-4">
                                ...
                                <h5 className='fs-4'>Bachelor of Computer Application</h5>
